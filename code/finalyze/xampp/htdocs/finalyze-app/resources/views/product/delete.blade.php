...
<br>
<br>
<h5> <b><u>DELETE product </u></b></h5>
<br>
<br>
            
			<form id="del-frm" method="POST" action=" ">
					...
					<label for="p_code"><b>Product Code:</b></label>
						...
						<input type="text" id="p_code" class="form-control mb-4" name="p_code"label="PRODUCT CODE"
							value= "{!! $products->p_code !!}" required>
                </div>
                ...
                <div class="control-group col-6 text-left">
					<label for="p_name"><b>Product Name:</b></label>
						...
						<input type="text" id="p_name" class="form-control mb-4" name="p_name"label="PRODUCT NAME"
							value= "{!! $products->p_name !!}" required>
                ...
                <div class="w3-bar-item w3-button w3-padding w3-center control-group col-6 text-center"><button type="submit"
                class="btn btn-outline-primary"><h7 style="color:DarkBlue;"><b>DELETE</b></h7></button></div>
